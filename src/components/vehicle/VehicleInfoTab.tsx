...
export function VehicleInfoTab({ vehicle, onUpdate, onAudit }: Props) {
  ...
  const handleSave = async () => {
    const normalizedPayload = {
      ...
      model_year: form.model_year ? parseInt(String(form.model_year)) : null,
      vehicle_class: form.vehicle_class || null,
      body_type: form.body_type || null,
      fuel_type: form.fuel_type || null,
      transmission: form.transmission || null,
      engine_displacement_cc: form.engine_displacement_cc ? parseInt(String(form.engine_displacement_cc)) : null,
      doors: form.doors ? parseInt(String(form.doors)) : null,
      capacity_passengers: form.capacity_passengers ? parseInt(String(form.capacity_passengers)) : null,
      color: form.color || null,
      mileage_km: form.mileage_km ? parseInt(String(form.mileage_km)) : null,
